...
function validarPrecioPaquete() {
    return validarNumeroNoVacio('precio2', 'precio2ValidationFeedback', 'Por favor ingrese un precio válido para el paquete.');
}

function validarPrecioEnvio() {
    return validarNumeroNoVacio('envio2', 'envio2ValidationFeedback', 'Por favor ingrese un precio válido para el envío.');
}

function validarTotalPagar() {
    return validarNumeroNoVacio('total2', 'total2ValidationFeedback', 'Por favor ingrese un total válido a pagar.');
}
...
function validarCobroEnvio() {
    var selectValue = document.getElementById('cenvio2').value;
    var validationFeedback = document.getElementById('cenvio2validationFeedback');
    if (selectValue === 'seleccione el estado cobro') {
        document.getElementById('cenvio2').classList.remove('is-valid');
        document.getElementById('cenvio2').classList.add('is-invalid');
        validationFeedback.style.display = 'block';
        return false;
    } else {
        document.getElementById('cenvio2').classList.remove('is-invalid');
        document.getElementById('cenvio2').classList.add('is-valid');
        validationFeedback.style.display = 'none';
        return true;
    }
}
...
document.getElementById('precio2').addEventListener('input', validarPrecioPaquete);
document.getElementById('envio2').addEventListener('input', validarPrecioEnvio);
document.getElementById('total2').addEventListener('input', validarTotalPagar);
// Evento para validar el campo al cambiar la selección
document.getElementById('cenvio2').addEventListener('change', validarCobroEnvio);
...
document.getElementById('kt_ecommerce_settings_general_store').addEventListener('submit', function(event) {
