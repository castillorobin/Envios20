    ...
    function validarPrecioPaquete() {
        return validarNumeroNoVacio('precio4', 'precio4ValidationFeedback', 'Por favor ingrese un precio válido para el paquete.');
    }

    function validarPrecioEnvio() {
        return validarNumeroNoVacio('envio4', 'envio4ValidationFeedback', 'Por favor ingrese un precio válido para el envío.');
    }

    function validarTotalPagar() {
        return validarNumeroNoVacio('total4', 'total4ValidationFeedback', 'Por favor ingrese un total válido a pagar.');
    }
    ...
    function validarCobroEnvio() {
        var selectValue = document.getElementById('cenvio4').value;
        var validationFeedback = document.getElementById('cenvio4ValidationFeedback');
        if (selectValue === 'seleccione el estado cobro') {
            document.getElementById('cenvio4').classList.remove('is-valid');
            document.getElementById('cenvio4').classList.add('is-invalid');
            validationFeedback.style.display = 'block';
            return false;
        } else {
            document.getElementById('cenvio4').classList.remove('is-invalid');
            document.getElementById('cenvio4').classList.add('is-valid');
            validationFeedback.style.display = 'none';
            return true;
        }
    }
    ...
    document.getElementById('precio4').addEventListener('input', validarPrecioPaquete);
    document.getElementById('envio4').addEventListener('input', validarPrecioEnvio);
    document.getElementById('total4').addEventListener('input', validarTotalPagar);
    // Evento para validar el campo al cambiar la selección
    document.getElementById('cenvio4').addEventListener('change', validarCobroEnvio);
    // Evento para validar el campo al cambiar la selección
    ...
    document.getElementById('kt_ecommerce_settings_general_products').addEventListener('submit', function(event) {
