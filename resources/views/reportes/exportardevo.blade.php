...
<div style="width:100%; " class="text-center centrar"> 
    ...
    <br>
           ...
           <div class="margenint " style="background-color: black; color:white; width:100%;">  <span style="background-color: black; color:white; width:100%;">Reporte ddevoluciones</span> </div>
