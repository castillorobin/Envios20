                ...
                <div id="kkt_content" class="content flex-column-fluid">
                    ...
                    <div id="kt_app_toolbar_container" class="d-flex flex-stack">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center ">
                            <!--begin::Title-->
                            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center mb-0">Reporte de entrega</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
                                        ...
                                        <tbody class="fw-semibold  text-gray-400">
                                            ...
                                            <tr class="'table-row-gray' : 'table-row-white' ">
                                                <td> 
                                                <a href="/envios/lisdoentregadatos/{{$ticket->id}}">
