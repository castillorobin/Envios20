...
-->
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    ...
                    <div class="flex-lg-auto min-w-lg-300px">
                        <!--begin::Card-->
                        <div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', lg: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="50px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
