                        ...
                        <div class="card mb-5 mb-xl-10">
                            <div class="card-body pt-9 pb-0">
                                ...
                                <li class="nav-item mt-2">
                                    ...
                                    <li class="nav-item mt-2">
                                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="/envios/puntoticket/{{$pedidos[0]->codigo}}">Punto fijo</a>
                                    </li>
                                    <li class="nav-item mt-2">
                        ...
                        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                            ...
                            <div class="card-header cursor-pointer">
                                ...
                                <div class="card-title m-0">
                                    <h3 class="fw-bold m-0">Detalles del ticket Punto fijo</h3>
                                </div>
                                <!--end::Card title--> 
                            </div>
                            <!--begin::Card header-->
