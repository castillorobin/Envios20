                ...
                <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            <!--begin::Title-->
                            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Solicitud de pago</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                               ...
                               <li class="breadcrumb-item text-muted">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Solicitud de pago</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
  ...
  <td >
    ...
    <button type="button" class="btn btn-secondary btn-cancelar" style="margin-left:10px;">Cancelar</button>
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-50px">Lugar de cobro</th>
                                                <th class="min-w-50px">Punto de cobro</th>
                            ...
                            @method('GET')
                                                ...
                                                <td>
                                                    @if($ticket->tipo_lugar == 'Punto fijo')
