                ...
                <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            <!--begin::Title-->
                            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Listado de entregas</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Listado de entregas</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <a href="/entregas" class="btn btn-sm fw-bold btn-primary" data-bs-target="#kt_modal_create_app">Crear entrega</a>
                            <!--end::Primary button-->
                        </div>
                        <!--end::Actions-->
                    </div>
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-title">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="search" spellcheck="false" data-ms-editor="true" id="dt-search-0" class="dt-input form-control form-control-solid w-250px ps-12" placeholder="Buscar ticket" />
                                    </div>
                                    <!--end::Search-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="tenvios">
                                        ...
                                        <tbody class="fw-semibold  text-gray-400">
                                            ...
                                            <tr class="'table-row-gray' : 'table-row-white' ">
                                                <td> <a href="/envios/detalle/{{$ticket->id}}" class="text-gray-900 text-hover-primary">
                                                    #{{$ticket->id}}
                                                    </a></td>
