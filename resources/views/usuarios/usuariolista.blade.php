                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                        ...
                                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                                            ...
                                            <!--begin::Input group-->
                                            <div class="mb-10">
                                                <label class="form-label fs-6 fw-semibold">Filtro por sesion</label>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                <thead>
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Sesion</th>
                                        <th class="min-w-125px">Fecha De Incorporación</th>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="{{ url('/usuarios/view') }}" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                                        ...
                                        <td>
                                            <div class="badge badge-light-danger fw-bold">Inactiva</div>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ url('/usuarios/view') }}" class="menu-link px-3">Edit</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <!--begin::User details-->
                                            <div class="d-flex flex-column">
                                                <a href="{{ url('/usuarios/view') }}" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
                                        ...
                                        <td>
                                            <div class="badge badge-light-success fw-bold">Activa</div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <!--begin::User details-->
                                            <div class="d-flex flex-column">
                                                <a href="{{ url('/usuarios/view') }}" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
