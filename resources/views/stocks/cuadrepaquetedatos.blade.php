...
<form action="{{ url('/stocks/cuadrepaquetedatosfiltro') }}" method="GET">
    ...
    <button type="button" class="btn btn-secondary " style="float: right; margin-left: 10px; ">Cancelar</button>
     ...
     <button type="button" class="btn btn-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" style="float: right; ">
                                    ...
                                    <div id="kt_ecommerce_report_shipping_export_menu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                             <a href="{{ route('cuadrepaquetedatos.export.excel', ['rango' => request('rango')]) }}" class="menu-link px-3">
                                                    Exportar a Excel
                                                </a>
                                        </div>
                                     
                                        <div class="menu-item px-3">
                                            <a href="{{ route('cuadrepaquetedatos.export.pdf', ['rango' => request('rango')]) }}" class="menu-link px-3" target="_blank">
                                                Exportar a PDF
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
