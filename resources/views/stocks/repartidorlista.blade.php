                        ...
                        <div class="card card-flush ">
                            ...
                            <div class="card-header align-items-center">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar repartidor" />
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
                                <thead>
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-50p0px">Telefono</th>
                                        <th class="min-w-50p0px">Correo</th>
                                    ...
                                    @for ($i = 0; $i < count($usuarios); $i++) <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="/repartidor/vista/{{ $usuarios[$i]->id }}" class="text-gray-800 text-hover-primary mb-1">{{ $usuarios[$i]->nombre }}</a>
                                        ...
                                        <td>
                                            ...
                                            <div class="badge badge-light fw-bold"> {{ $usuarios[$i]->telefono }}  </div>
                                        </td>
