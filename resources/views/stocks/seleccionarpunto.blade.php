                        ...
                        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fw-bold fs-6 text-gray-800" style="font-size: 30px !important;">El congo</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <span class="fw-bold fs-6 text-gray-800" style="font-size: 30px !important;">Espacio 3</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <div class="row mb-7">
