...
Route::post('pago/pagoticket/', [App\Http\Controllers\PagoController::class, 'pagoticket'] )->name('pagoticket') ;
...
Route::get('/envios/lisdodevolista/{id}', [App\Http\Controllers\PagoController::class, 'lisdodevolista'] )->name('lisdodevolista') ;
...
Route::get('/stocks/listapifiltro', [App\Http\Controllers\StockController::class, 'listapifiltro'] )->name('listapifiltro');

Route::get('/stocks/detallepick/{id}', [App\Http\Controllers\StockController::class, 'detallepick'] )->name('detallepick');
Route::get('/stocks/realizado/', [App\Http\Controllers\StockController::class, 'realizado'] )->name('realizado');
...
Route::get('/pago/exportarExcel/{ticketc}', [App\Http\Controllers\EnvioController::class, 'exportarExcel'])
    ...
    Route::get('/destino/editar/{id}', [App\Http\Controllers\RutaController::class, 'editardestino'] )->name('editardestino') ;
